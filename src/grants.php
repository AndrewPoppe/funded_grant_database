...
<body>
	...
	<div id="container" style="padding-left:8%;  padding-right:10%; margin-left:auto; margin-right:auto; ">
		<div id="header">
			...
			<p style="font-size:small;">If you have comments, questions, or concerns, please send an email to <a href="mailto:<?php echo \REDCap::escapeHtml($module->configuration["contact"]["email"]) ?>"> <?php echo \REDCap::escapeHtml($module->configuration["contact"]["email"]) ?></a>.</p>
			<hr />
		</div>
